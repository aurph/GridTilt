...
export const supplyNodes: SupplyNode[] = [
  ...
  { id: 'copper',       name: 'Copper',            stage: 'raw-materials', stageIndex: 0, icon: 'Pickaxe',       companies: [{ ticker: 'FCX', name: 'Freeport-McMoRan' },{ ticker: 'SCCO', name: 'Southern Copper' },{ ticker: 'TECK', name: 'Teck Resources' },{ ticker: 'HBM', name: 'Hudbay Minerals' }], description: 'In everything: wiring, transformers, cables. $14,200/ton. AI could need 475K additional tons/yr.', keyMetric: { value: '$14,200/ton', label: 'Price' } },
  { id: 'steel',        name: 'Steel',             stage: 'raw-materials', stageIndex: 0, icon: 'Hammer',        companies: [{ ticker: 'NUE', name: 'Nucor' },{ ticker: 'STLD', name: 'Steel Dynamics' },{ ticker: 'CLF', name: 'Cleveland-Cliffs' },{ ticker: 'X', name: 'US Steel' }], description: 'Electrical steel for transformer cores. 8-12 month lead times. Structural steel for towers and DC frames.', keyMetric: { value: '8-12 mo', label: 'Lead time' } },
  ...
  { id: 'substations',  name: 'Substations',       stage: 'transmission', stageIndex: 2, icon: 'Workflow',      companies: [{ ticker: 'ETN', name: 'Eaton Corporation' },{ ticker: 'ABB', name: 'ABB Ltd' },{ ticker: 'HUBB', name: 'Hubbell Inc' },{ ticker: 'DUK', name: 'Duke Energy' },{ ticker: 'AEP', name: 'American Electric Power' }], description: 'Where utility grid meets the customer. Step-down voltage for distribution. New DC substations can require 100-500 MW dedicated capacity.', keyMetric: { value: '100-500 MW', label: 'Per DC site' } },
  ...
  { id: 'miners',       name: 'Crypto Miners',     stage: 'end-use', stageIndex: 4, icon: 'Bitcoin',       companies: [{ ticker: 'IREN', name: 'IREN Limited' },{ ticker: 'CLSK', name: 'CleanSpark' },{ ticker: 'MARA', name: 'Marathon Digital' }], description: 'Former crypto miners pivoting to AI/HPC hosting. Already have power contracts, cooling, and cheap land.' },
