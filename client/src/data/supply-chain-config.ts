...
export const supplyNodes: SupplyNode[] = [
  ...
  { id: 'dc-reits',     name: 'Datacenter REITs',  stage: 'end-use', stageIndex: 4, icon: 'Landmark',      companies: [{ ticker: 'EQIX', name: 'Equinix' },{ ticker: 'DLR', name: 'Digital Realty' },{ ticker: 'AMT', name: 'American Tower' }], description: 'Data center landlords. Equinix: 273 DCs worldwide. Digital Realty: largest portfolio.', keyMetric: { value: '273', label: 'EQIX DCs' } },
  ...
  { id: 'miners',       name: 'Crypto Miners',     stage: 'end-use', stageIndex: 4, icon: 'Bitcoin',       companies: [{ ticker: 'IREN', name: 'IREN Limited' },{ ticker: 'CLSK', name: 'CleanSpark' },{ ticker: 'MARA', name: 'Marathon Digital' }], description: 'Crypto miners pivoting to AI hosting. Already have power contracts and cooling infra.' },
];
