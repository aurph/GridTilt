...
export const supplyNodes: SupplyNode[] = [
  ...
  { id: 'rare-earth',   name: 'Rare Earth',        stage: 'raw-materials', stageIndex: 0, icon: 'Gem',           companies: [{ ticker: 'MP', name: 'MP Materials' }], description: 'Magnets for generators/motors. China controls 90% of processing.', keyMetric: { value: '90%', label: 'China processing' } },
  { id: 'natural-gas',  name: 'Natural Gas',       stage: 'raw-materials', stageIndex: 0, icon: 'Flame',         companies: [{ ticker: 'AR', name: 'Antero Resources' },{ ticker: 'EQT', name: 'EQT Corporation' },{ ticker: 'RRC', name: 'Range Resources' },{ ticker: 'LNG', name: 'Cheniere Energy' }], description: 'Fuel for gas turbines. US production at record highs.', keyMetric: { value: 'Record', label: 'US production' } },
  ...
  { id: 'hv-cable',     name: 'HV Cable',          stage: 'transmission', stageIndex: 2, icon: 'Cable',         companies: [{ ticker: 'NVT', name: 'nVent Electric' }], description: 'High-voltage lines carrying power from plants to demand centers.', keyMetric: { value: 'Growing', label: 'Queue' } },
  ...
  { id: 'dc-build',     name: 'DC Construction',   stage: 'distribution', stageIndex: 3, icon: 'Building',      companies: [{ ticker: 'EME', name: 'EMCOR Group' },{ ticker: 'MTZ', name: 'MasTec' },{ ticker: 'STRL', name: 'Sterling Infrastructure' },{ ticker: 'FLR', name: 'Fluor Corporation' },{ ticker: 'PRIM', name: 'Primoris Services' }], description: 'Physical build of data centers. Sterling 125% YoY DC growth. Largest pipeline ever.', keyMetric: { value: '125% YoY', label: 'STRL growth' } },
...
export const supplyLinks: SupplyLink[] = [
  { source: 'uranium',     target: 'nuclear',       label: 'fuel' },
  { source: 'uranium',     target: 'smrs',          label: 'HALEU fuel' },
  { source: 'natural-gas', target: 'gas-turbines',  label: 'fuel' },
  { source: 'rare-earth',  target: 'solar',         label: 'magnets' },
  { source: 'rare-earth',  target: 'nuclear',       label: 'generator magnets' },

  { source: 'copper',      target: 'transformers',  label: 'windings' },
  { source: 'copper',      target: 'hv-cable',      label: 'conductor' },
  { source: 'steel',       target: 'transformers',  label: 'cores' },
  { source: 'steel',       target: 'line-const',    label: 'towers' },

  { source: 'copper',      target: 'switchgear',    label: 'busbars' },
  { source: 'steel',       target: 'dc-build',      label: 'structural' },

  { source: 'nuclear',     target: 'transformers',  label: 'output' },
  { source: 'gas-turbines',target: 'transformers',  label: 'output' },
  { source: 'solar',       target: 'transformers',  label: 'output' },
  { source: 'smrs',        target: 'transformers',  label: 'output' },
  { source: 'nuclear',     target: 'line-const',    label: 'interconnect' },
  { source: 'solar',       target: 'hv-cable',      label: 'interconnect' },

  { source: 'transformers',target: 'switchgear',    label: 'stepped-down power' },
  { source: 'transformers',target: 'power-mgmt',    label: 'facility power' },
  { source: 'hv-cable',    target: 'switchgear',    label: 'delivery' },
  { source: 'line-const',  target: 'dc-build',      label: 'site connection' },
  ...
  { source: 'copper',      target: 'dc-build',      label: 'wiring' },
