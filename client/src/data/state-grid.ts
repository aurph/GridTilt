...
export const STATE_GRID: Record<string, StateGrid> = {
  ...
  MS: { name: "Mississippi", region: "MISO", operatorLabel: "MISO South" },
  MO: { name: "Missouri", region: "MISO", operatorLabel: "MISO (east), SPP (west)", note: "Eastern Missouri is MISO; western utilities are SPP. Figures shown are MISO." },
  MT: { name: "Montana", region: "WECC", operatorLabel: "Western grid (WECC)", note: "Most of Montana is on the Western grid; the eastern edge is MISO." },
  ...
  ND: { name: "North Dakota", region: "MISO", operatorLabel: "MISO (east), SPP (west)", note: "Figures shown are MISO." },
  ...
  SD: { name: "South Dakota", region: "SPP", operatorLabel: "SPP (west), MISO (east)", note: "Figures shown are SPP." },
  TN: { name: "Tennessee", region: "SERC", operatorLabel: "TVA territory (SERC)" },
  TX: { name: "Texas", region: "ERCOT", operatorLabel: "ERCOT", note: "Most of Texas is ERCOT; the Panhandle and eastern edges sit in SPP and MISO." },
