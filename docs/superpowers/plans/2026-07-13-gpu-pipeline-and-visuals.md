...
- [x] **Step 1: Write failing tests for HTTP, thrown, partial, and total failures**
...
- [x] **Step 3: Implement typed provider request results**
...
- [x] **Step 1: Write failing history-summary and metadata tests**
...
- [x] **Step 3: Implement pure summary and enriched recorded series**
...
- [x] **Step 4: Run focused tests and full index regression**
...
- [x] **Step 3: Implement thin route integration**
...
- [x] **Step 1: Build an importable n8n workflow**
...
- [x] **Step 2: Document setup and failure behavior**
...
- [x] **Step 3: Validate workflow JSON and docs**
...
- [x] **Step 1: Write failing series tests**
...
- [x] **Step 1: Wire local API types and state defaults**
...
- [x] **Step 2: Add health provenance and coverage-aware controls**
...
- [x] **Step 3: Render honest segments, points, and dispersion**
...
- [x] **Step 4: Complete sparse states and tooltip**
...
- [x] **Step 5: Verify UI compilation and focused tests**
...
- [x] **Step 1: Add the cost-efficiency chart**
...
- [x] **Step 2: Add the MFU sensitivity curve**
...
- [x] **Step 3: Add empty and loading states**
...
- [x] **Step 4: Verify tests, typecheck, and build**
...
- [x] **Step 2: Verify protected invariants**
...
- [x] **Step 3: Inspect both tabs at wide and narrow widths**
...
- [x] **Step 5: Deliver owner actions**
...
Verified on 2026-07-13 at commit `1887ae9` and the documentation closeout commit that follows it:

- `npm test`: 249 passed, 0 failed, 0 skipped.
- `npm run check`: TypeScript exited 0.
- `npm run build`: Vite client and esbuild server production bundles completed.
- The n8n history backup parsed as importable JSON; all nine nodes and every connection target were validated; both Code nodes parsed; the workflow is inactive by default and scheduled for Sunday 04:30 America/New_York.
- `gpu-rental-prices.json`, all whole-file `CLAUDE.md` protected files, and the protected route/security logic remained unchanged. The new admin route is an additive call to the existing `requireAdmin` boundary.
- The history chart is visx-only and carries explicit recorded, estimated-anchor, and recorded-spread evidence classes.
- Browser QA covered the prices and economics tabs at 1440x1000 and 390x844, including grid/overlay, log/linear URL state, model and preset inputs, real-point tooltip provenance, chart labels, responsive stacking, and overflow checks. Browser console warnings/errors: none.
